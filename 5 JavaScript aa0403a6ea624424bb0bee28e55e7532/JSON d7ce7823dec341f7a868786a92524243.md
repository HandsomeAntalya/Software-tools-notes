...
This article provides an introduction to JSON, including its structure, how to access data within it using dot/bracket notation, and how to convert between JSON and JavaScript objects using the built-in JSON object's parse() and stringify() methods. It also includes a detailed example of how to use JSON data in a website, including retrieving JSON data using the Fetch API and displaying it using DOM manipulation.

- [ ]  Learn the structure of JSON
- [ ]  Access data within JSON using dot/bracket notation
- [ ]  Convert between JSON and JavaScript objects using JSON.parse() and JSON.stringify() methods
- [ ]  Retrieve JSON data using the Fetch API
- [ ]  Display JSON data using DOM manipulation
...
![https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Objects/JSON/json-superheroes.png](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Objects/JSON/json-superheroes.png)
...
- we make the network request using the `[fetch()](https://developer.mozilla.org/en-US/docs/Web/API/fetch)` function, and this returns a `[Response](https://developer.mozilla.org/en-US/docs/Web/API/Response)` object
- we retrieve the response as JSON using the `[json()](https://developer.mozilla.org/en-US/docs/Web/API/Response/json)` function of the `Response` object.
...
- we retrieve the response as text rather than JSON, by calling the `[text()](https://developer.mozilla.org/en-US/docs/Web/API/Response/text)` method of the response
